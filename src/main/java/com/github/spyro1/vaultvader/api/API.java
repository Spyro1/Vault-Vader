 ...
 * login/registration, item management, category management, and temporal item handling.
 * @author Spyro1
 * @version 1.0
 */
public class API {
    ...
    /**
     * Removes the searched title given in the itemData parameter. If the parameter is null, then it removes the
     * temporal item from the list.

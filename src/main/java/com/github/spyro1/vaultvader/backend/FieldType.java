...
/**
 * The FieldType enum defines the type of field. It supports three types:
 * TEXT, PASS, and CATEGORY. It also provides utility methods for converting
 * between strings and enum values.
 */

...
/**
 * The Field class represents a data field with a name, value, and type. It implements the JSONSerializable interface to
...
public class Field implements JSONSerializable {
    ...
    /**
     * Default constructor that initializes a Field with an empty name, empty value, and a default type of
     * FieldType.TEXT.
     */
    public Field() {
        this("", "", FieldType.TEXT);
    ...
    /**
     * Constructor that initializes a Field with a specified field name and an empty value. The type defaults to
     * FieldType.TEXT.
    ...
    /**
     * Constructor that initializes a Field with a specified field name and value. The type defaults to FieldType.TEXT.
     * @param fieldName the name of the field.
    ...
    /**
     * Constructor that initializes a Field with a specified field name, value, and type.
     * @param fieldName the name of the field.
     * @param value the value of the field.
    ...
    /**
     * Returns a string representation of the field in the format: "fieldName: value [type]".
